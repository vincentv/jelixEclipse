...
public class JelixIni {
	...
	public JelixIni(){
		...
		// definition
		this.definition = "; nom de la connexion utilis�e par d�faut" + this.cr;
		this.definition += "default = ";
		
		// commentaire
		this.commentaire = "; chaque section correspond � une connexion" + this.cr;
		this.commentaire += "; le nom de la section est le nom de la connexion utilis� dans jDb et jDao" + this.cr;
		this.commentaire += "; la liste des param�tres d�pend du driver." + this.cr;
