...
public class JelixPreferencePage extends FieldEditorPreferencePage implements
	...
	public void createFieldEditors() {
		...
		addField(new FileFieldEditor(PreferenceConstants.P_PATH_JELIX_PHP,
				Messages.JelixPreferencePage_PHPPath, composite));
		addField(new FileFieldEditor(PreferenceConstants.P_PATH_JELIX_MYSQL,
				Messages.JelixPreferencePage_MysqlPath, composite));
